...
class _TelaRegistrarExtintorState extends State<TelaRegistrarExtintor> {
  ...
  Future<void> fetchCapacidades() async {
    final response =
        await http.get(Uri.parse('http://localhost:3000/capacidades'));
  ...
  Future<void> fetchTipos() async {
    ...
    if (cachedTipos != null) {
      ...
      final response =
          await http.get(Uri.parse('http://localhost:3000/tipos-extintores'));
  ...
  Future<void> fetchLocalizacoes(String linhaId) async {
    final response = await http
        .get(Uri.parse('http://localhost:3000/localizacoes?linhaId=$linhaId'));
    if (response.statusCode == 200) {
      setState(() {
  ...
  Future<void> _registrarExtintor() async {
    ...
    try {
      final response = await http.post(
        Uri.parse('http://localhost:3000/registrar_extintor'),
